...
FUNCTION POSICION_ID_TITULO (ID:integer;TITULO:Tv_titulo):integer;
  ...
  Function pasillo_estante_valido (pas, est:byte; id_gen:integer; genero:Tv_genero):boolean;
	...
	PROCEDURE INGRESO (VAR EJEMPLAR: TV_EJEMPLAR; VAR TITULO:TV_TITULO; VAR GENERO: TV_GENERO; var LONG_VECTOR:INTEGER);
	    ...
	    clrscr;
      writeln;
			Write ('Ingrese el ID de ejemplar que desea ingresar: ');
     	Readln  (ID);
          ...
          clrscr;
					writeln;
					writeln;
		 			write ('El ID ingresado ya esta asignado a otro ejemplar');
		 			write ('Engrese nuevamente el ID: ');
		 			readln (id);	
				end;
      ...
      readln (estante);
            ...
            clrscr;
		 				...
		 				writeln;
		 				write ('Ingrese nuevamente el pasilloe n el que desea ubicar el ejemplar: ');
		 				readln  (pasillo);
		 				writeln;
		 				Write ('Ingrese el estante en el que desea ubicar el ejemplar: ');
					  readln  (estante);
	 ...
	 PROCEDURE EGRESO (var Ejemplar:tv_ejemplar; long_vector:integer);
   		var
			...
			begin
				clrscr;
        writeln;
				Write ('Ingrese el ID de ejemplar que desea egresar: ');
				readln (id);
				...
				while (posicion_ejemplar  (id,ejemplar,long_vector)=-1)do
					...
					begin   clrscr;
		 				writeln;
		 				write ('El ejemplar no existe');
		 				writeln;
		 				write ('Engrese nuevamente el ID del ejemplar: ');
		 				readln (id);
		 			end;
