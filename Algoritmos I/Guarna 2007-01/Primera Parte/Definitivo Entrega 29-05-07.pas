...
hasta la ubicación actual del cursor, dejandolo en la posicion ingresada ** }
Var
   J,Y:byte;
Begin
	y:=wherey;
...
en "id del titulo a modificar",además se puede, o no, guardar los datos cambiados ***}
						...
						Begin
							...
							If pos_au_nuevo=-1  then 
								begin
									...
									writeln ('Modificación realizada exitosamente');
								end
							else
								If  not (v_autor[pos_au_nuevo].estado) then
									begin
										...
										v_autor[pos_au_ant].id_autor:=id_nuevo;
										writeln ('Modificación realizara exitosamente')
									end
								else
									begin
...
{ * * *  M O D I F I C A C I Ó N    G É N E R O S  * * * }
...
Begin
	repeat
		...
		case opt of
			...
			7: Visualizaciones(v_titulo,v_ejemplar,v_autor,v_genero,largo_autor,largo_titulo,largo_ejemplar);
		end;
